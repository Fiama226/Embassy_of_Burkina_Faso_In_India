...
async function PatrioticSupport() {
  ...
  return (
    <section
      ...
      className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20"
    >
      <div className="bg-white rounded-2xl shadow-lg border border-stone-200 overflow-hidden">
        {/* ── National Colors Bar ─────────────────────────── */}

        {/* ── Header ──────────────────────────────────────── */}
        <header className="px-6 lg:px-12 pt-10 lg:pt-14 pb-8 text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-stone-900 text-amber-400 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest mb-6">
          ...
          <h2
            ...
            className="text-3xl lg:text-5xl font-serif font-bold text-stone-900 leading-tight mb-4"
          >
            {t("title")}
          </h2>
        ...
        <div className="px-6 lg:px-12 pb-10 lg:pb-14">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
            ...
            <div className="w-full lg:w-5/12 flex flex-col items-center justify-center">
              <figure>
                <div className="relative rounded-xl overflow-hidden shadow-xl ring-1 ring-stone-200">
                  <Image
                  ...
                  {/* Overlay caption bar */}
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-stone-900/80 to-transparent px-5 pb-4 pt-10">
              ...
              <div className="mt-6 bg-stone-900 rounded-xl p-6 text-white">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-serif font-bold text-lg text-amber-50 mb-2">
                      {t("callout.title")}
                    </p>
            ...
            <div className="w-full lg:w-7/12">
                ...
                {documents.map((doc, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className="
                          relative flex items-center gap-5 p-5 sm:p-6
                      ...
                      >
                        ...
                        >
                          {isPDF ? (
                            ...
                            <GlobeIcon className="w-6 h-6 text-amber-600 transition-colors duration-300" />
                          )}
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <p
                            className={`
                              font-bold text-base sm:text-lg text-stone-900
                              transition-colors duration-300 leading-snug mb-1
                              ${
                                index === 0
                        ...
                        >
                          {isPDF ? (
                            <DownloadIcon className="w-5 h-5 text-stone-500 group-hover:text-stone-700 transition-colors" />
                          ) : (
                            <ExternalIcon className="w-5 h-5 text-stone-500 group-hover:text-stone-700 transition-colors" />
                          )}
                        </div>
                      </div>
                    </a>
              ...
              {/* ── Help Text ──────────────────────────────── */}
              <p className="text-sm text-stone-500 mt-6 flex items-start gap-2.5 leading-relaxed">
                <svg
