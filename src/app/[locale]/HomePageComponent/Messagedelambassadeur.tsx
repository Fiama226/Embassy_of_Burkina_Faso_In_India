...
async function Messagedelambassadeur() {
  ...
  return (
    <section className="generalsection w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
      {/* Section Header */}
      <div className="text-center mb-12">
        <div className="inline-block">
          <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold font-serif text-stone-900 mb-4 leading-[1.15]">
            {msg("title")}
          </h2>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8 lg:p-12">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <div className="relative w-full aspect-square rounded-lg overflow-hidden shadow-xl border-4 border-gray-100">
                <Image
                  alt={msg("alt")}
          ...
          <div className="lg:col-span-2">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="relative mb-8">
                <div className="absolute -left-4 -top-2 text-6xl text-[#EF2D2D] opacity-20 font-serif">"</div>
                <p className="text-xl lg:text-2xl leading-relaxed text-gray-800 font-serif italic pl-8">
                  {msg("text1")}
                </p>
              </div>
