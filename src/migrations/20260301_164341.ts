...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_actualites_v_locales" (
  	...
  	"version_text_before_carousel" jsonb,
  ...
  ALTER TABLE "actualites_carousel" ADD CONSTRAINT "actualites_carousel_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "actualites_carousel" ADD CONSTRAINT "actualites_carousel_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."actualites"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "actualites_carousel_locales" ADD CONSTRAINT "actualites_carousel_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."actualites_carousel"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "actualites" ADD CONSTRAINT "actualites_og_image_id_media_id_fk" FOREIGN KEY ("og_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "actualites" ADD CONSTRAINT "actualites_author_id_users_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "actualites_rels" ADD CONSTRAINT "actualites_rels_tags_fk" FOREIGN KEY ("tags_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_actualites_v_version_carousel" ADD CONSTRAINT "_actualites_v_version_carousel_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_actualites_v_version_carousel" ADD CONSTRAINT "_actualites_v_version_carousel_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_actualites_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_actualites_v_version_carousel_locales" ADD CONSTRAINT "_actualites_v_version_carousel_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_actualites_v_version_carousel"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_actualites_v" ADD CONSTRAINT "_actualites_v_version_og_image_id_media_id_fk" FOREIGN KEY ("version_og_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_actualites_v" ADD CONSTRAINT "_actualites_v_version_author_id_users_id_fk" FOREIGN KEY ("version_author_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_actualites_v_rels" ADD CONSTRAINT "_actualites_v_rels_tags_fk" FOREIGN KEY ("tags_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "actualites_carousel_order_idx" ON "actualites_carousel" USING btree ("_order");
  CREATE INDEX "actualites_carousel_parent_id_idx" ON "actualites_carousel" USING btree ("_parent_id");
  CREATE INDEX "actualites_carousel_image_idx" ON "actualites_carousel" USING btree ("image_id");
  CREATE UNIQUE INDEX "actualites_carousel_locales_locale_parent_id_unique" ON "actualites_carousel_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "actualites_og_image_idx" ON "actualites" USING btree ("og_image_id");
  CREATE UNIQUE INDEX "actualites_slug_idx" ON "actualites" USING btree ("slug");
  CREATE INDEX "actualites_author_idx" ON "actualites" USING btree ("author_id");
  ...
  CREATE INDEX "actualites_rels_order_idx" ON "actualites_rels" USING btree ("order");
  CREATE INDEX "actualites_rels_parent_idx" ON "actualites_rels" USING btree ("parent_id");
  CREATE INDEX "actualites_rels_path_idx" ON "actualites_rels" USING btree ("path");
  CREATE INDEX "actualites_rels_categories_id_idx" ON "actualites_rels" USING btree ("categories_id");
  CREATE INDEX "actualites_rels_tags_id_idx" ON "actualites_rels" USING btree ("tags_id");
  CREATE INDEX "_actualites_v_version_carousel_order_idx" ON "_actualites_v_version_carousel" USING btree ("_order");
  CREATE INDEX "_actualites_v_version_carousel_parent_id_idx" ON "_actualites_v_version_carousel" USING btree ("_parent_id");
  CREATE INDEX "_actualites_v_version_carousel_image_idx" ON "_actualites_v_version_carousel" USING btree ("image_id");
  CREATE UNIQUE INDEX "_actualites_v_version_carousel_locales_locale_parent_id_uniq" ON "_actualites_v_version_carousel_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "_actualites_v_parent_idx" ON "_actualites_v" USING btree ("parent_id");
  CREATE INDEX "_actualites_v_version_version_og_image_idx" ON "_actualites_v" USING btree ("version_og_image_id");
  CREATE INDEX "_actualites_v_version_version_slug_idx" ON "_actualites_v" USING btree ("version_slug");
  CREATE INDEX "_actualites_v_version_version_author_idx" ON "_actualites_v" USING btree ("version_author_id");
  ...
  CREATE INDEX "_actualites_v_rels_order_idx" ON "_actualites_v_rels" USING btree ("order");
  CREATE INDEX "_actualites_v_rels_parent_idx" ON "_actualites_v_rels" USING btree ("parent_id");
  CREATE INDEX "_actualites_v_rels_path_idx" ON "_actualites_v_rels" USING btree ("path");
  CREATE INDEX "_actualites_v_rels_categories_id_idx" ON "_actualites_v_rels" USING btree ("categories_id");
  CREATE INDEX "_actualites_v_rels_tags_id_idx" ON "_actualites_v_rels" USING btree ("tags_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "actualites_carousel" CASCADE;
  DROP TABLE "actualites_carousel_locales" CASCADE;
  DROP TABLE "actualites" CASCADE;
  DROP TABLE "actualites_locales" CASCADE;
  DROP TABLE "actualites_rels" CASCADE;
  DROP TABLE "_actualites_v_version_carousel" CASCADE;
  DROP TABLE "_actualites_v_version_carousel_locales" CASCADE;
