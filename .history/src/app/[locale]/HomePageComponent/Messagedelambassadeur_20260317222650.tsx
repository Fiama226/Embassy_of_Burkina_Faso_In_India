...
async function Messagedelambassadeur() {
  ...
  return (
    <section className="generalsection w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
      {/* Section Header */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 p-4 sm:p-8 lg:p-12">
          ...
          <div className="lg:col-span-1 mb-8 lg:mb-0">
            <div className="sticky top-24">
              <div className="relative w-40 h-40 sm:w-full sm:aspect-square rounded-lg overflow-hidden shadow-xl border-4 border-gray-100 mx-auto">
                <Image
                  alt={msg("alt")}
                  ...
                  sizes="(max-width: 640px) 160px, (max-width: 1024px) 100vw, 33vw"
                />
              </div>
