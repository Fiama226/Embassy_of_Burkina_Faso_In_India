  ...
  return (
    <article className="bg-white rounded-2xl p-5 shadow-md border border-stone-100 hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="flex justify-center mb-3">
        <div className="relative w-16 h-11 rounded-lg overflow-hidden shadow-sm ring-1 ring-stone-200">
          {/* Using img tag for SVG flags - Next.js Image doesn't optimize SVGs */}
          <img
            src={ "/public/flags/Flag_of_Burkina_Faso.svg"}
            alt={flagAlt}
...
<Image src={"/public/flags/Flag_of_Burkina_Faso.svg"} alt={flagAlt} fill className="object-cover" sizes="64px" />
              <span>{t("badge")}</span>
            </div>
